...
from analytical_model_atm import *
import time
...
if __name__ == '__main__':
    ...
    print('test')
    # import MCMC class
    mcmc = MCMC('K2-141b_atm', 'Kepler', sigma=2.5, ndim=8, nwalkers=64, nsteps=2000, burnin=1000)
    # set parameters
    ...
    # plot each function
    F_thermal1 = F_thermal(Theta_array, omega, F, Tss, Rp2Rs, inc)
    F_specular1 = F_atmospheric(Theta_array, omega, g, Rp2Rs, inc)
    F_thermal2 = F_thermal(Theta_array, omega, F, Tss, Rp2Rs, 90)
    F_specular2 = F_atmospheric(Theta_array, omega, g, Rp2Rs, 90)
    ...
    # test Fp2Fs() function
    plt.subplots()
    plt.plot(Theta_array, Fp2Fs(Theta_array, params=[omega, g, Tss, Rp2Rs, F, inc, PPs.alpha, alpha_ellipse]))
    plt.plot(Theta_array, F_thermal1 + F_specular1 + F_ellip1 + F_tr, '--b')
