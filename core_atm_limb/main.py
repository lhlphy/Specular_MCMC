...
TARGET_NAME = os.environ.get("MCMC_TARGET_NAME", "K2-141b_atm_limb")
...
if __name__ == '__main__':
    ...
    mcmc = MCMC(TARGET_NAME, OBSERVATION_NAME, sigma=7.05, ndim=10, nwalkers=64, nsteps=5000, burnin=2500)
    mcmc.sample(resume=resume, nsteps=run_steps)
    mcmc.plot_trace()
    mcmc.plot_corner()
    # mcmc.plot_omega_distribution()
    mcmc.compute_rhat()
