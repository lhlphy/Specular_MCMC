...
TARGET_NAME = os.environ.get("MCMC_TARGET_NAME", "Kepler-78b_atm_limb")
...
if __name__ == '__main__':
    ...
    mcmc = MCMC(TARGET_NAME, OBSERVATION_NAME, sigma=3.0, ndim=13, nwalkers=64, nsteps=N_STEPS, burnin=BURNIN)
