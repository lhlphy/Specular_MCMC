...
class MCMC:
    def __init__(self, target_name, file_name, sigma=10, ndim=10, nwalkers=120, nsteps=2000, burnin=1000):
        ...
        self.nsteps = nsteps
        self.burnin = burnin
        self.labels = [r"$\omega$", "g", r"$T_{\rm sub}$", "Rp/Rs", "F", "inc", r"$\alpha$", "u1", "u2", "delta"]
    ...
    def _initial_positions(self):
        ...
        initial[:, 9] = np.random.uniform(low=-10.0, high=10.0, size=self.nwalkers)
        return initial
    ...
    def log_prior(self, params):
        omega, g, Tss, Rp2Rs, F, inc, alpha, co1, co2, delta = params
