...
def Fp2Fs(Theta_array, AB, alpha_ellip, delta =0, Tss = Tss_ref, Rp2Rs = 0, F=0):
    return F_thermal(Theta_array, AB, F, Tss, Rp2Rs) + F_lambert(Theta_array, AB, Rp2Rs) + F_ellip(Theta_array, alpha_ellip) + delta
