#!/bin/bash
#SBATCH --job-name=k2141b_spec
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32
#SBATCH --partition=wzhctdnormal
#SBATCH -o results/slurm_spec_%j.out
#SBATCH -e results/slurm_spec_%j.err
...
python -m nested_sampler.run \
    ...
    --sample rwalk \
    --bound multi \
    --outdir "results/server_${SLURM_JOB_ID:-manual}_specular_limb"
