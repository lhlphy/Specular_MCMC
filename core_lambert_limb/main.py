...
TARGET_NAME = os.environ.get("MCMC_TARGET_NAME", "K2-141b_lambert_limb")
...
if __name__ == '__main__':
    ...
    mcmc = MCMC(TARGET_NAME, OBSERVATION_NAME, sigma=7.05, ndim=9, nwalkers=64, nsteps=4000, burnin=1500)
